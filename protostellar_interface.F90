...
double precision, parameter :: Lsun = 3.839D33           ! in erg
double precision, parameter :: sigma = 5.67040D-05       ! Stefan-Boltzmann
double precision, parameter :: G = 6.67428D-08
...
contains
    ...
    subroutine get_model_table_cols(models,n,xi,zfin,Dn,Bn,massparam)
        ...
        !
        !       All arguments are optional arguments, except 'models'. The keywords 
        !       must be specified in the form of keyword=argument. getNumModels must
        !       be run first so that arrays can be sized correctly.
        !
...
end module protostellar_interface
